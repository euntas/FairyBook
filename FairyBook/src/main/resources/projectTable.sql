...
--책표지 resources
  CREATE TABLE COVERRESOURCES 
   (	STORYNUM NUMBER NOT NULL ENABLE, 
	"TYPE" VARCHAR2(20 BYTE) NOT NULL ENABLE, --background, title, character
	PATH VARCHAR2(100 BYTE) NOT NULL ENABLE, 
	 CONSTRAINT COVERRESOURCES_FK1 FOREIGN KEY (STORYNUM)
	  REFERENCES FAIRYTALE (STORYNUM) ON DELETE CASCADE ENABLE
   ) 
