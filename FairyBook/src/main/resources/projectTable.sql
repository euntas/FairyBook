...
DROP SEQUENCE HR.BOARDNUM_SEQ;
DROP SEQUENCE HR.QUIZNUM_SEQ;
DROP SEQUENCE HR.REPLYNUM_SEQ;
DROP SEQUENCE HR.RESOURCENUM_SEQ;
DROP SEQUENCE HR.SCENENUM_SEQ;
DROP SEQUENCE HR.SELECTIONNUM_SEQ;
DROP SEQUENCE HR.STORYNUM_SEQ;
...
CREATE SEQUENCE HR.BOARDNUM_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE HR.QUIZNUM_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE HR.REPLYNUM_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE HR.RESOURCENUM_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE HR.SCENENUM_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE HR.SELECTIONNUM_SEQ INCREMENT BY 1 START WITH 1;
CREATE SEQUENCE HR.STORYNUM_SEQ INCREMENT BY 1 START WITH 1;
